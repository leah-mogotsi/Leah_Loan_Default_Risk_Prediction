...
.app-header h1 { font-family: 'Playfair Display', serif; font-size: 1.9rem; color: var(--gold2); margin: 0; }
...
.result-card { border-radius: 12px; padding: 1.8rem 2rem; text-align: center; margin-top: 0.5rem; }
.result-card.default {
...
.flag-number { font-family: 'Playfair Display', serif; font-size: 7rem; font-weight: 700; line-height: 1; margin-bottom: 0.4rem; }
...
.flag-label { font-family: 'Playfair Display', serif; font-size: 1.3rem; font-weight: 700; margin-bottom: 0.3rem; }
...
.flag-rec { font-size: 0.82rem; color: var(--gold2); background: rgba(201,168,76,0.1); border-radius: 8px; padding: 0.6rem 1rem; display: inline-block; }
.metric-card { background: var(--card); border: 1px solid var(--border); border-radius: 10px; padding: 1rem 1.2rem; text-align: center; }
...
with st.sidebar:
    ...
    <div style='text-align:center; padding:1rem 0 1.5rem;'>
        ...
        <div style='font-family:Playfair Display,serif; color:#f0c96b; font-size:1.1rem; font-weight:600;'>Alpha Dreamers</div>
